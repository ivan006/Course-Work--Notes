...
- A model - (action queries) - Is the page data map
- A view - (action responce template) - Is the page action responce template
- A page rendition - (action responce) - Is the page action responce
